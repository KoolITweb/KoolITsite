    ...
    return(
        <div>
            ...
            <div id="rotating-gallery">
                <figure class="APItest" onClick={() => window.open("/test/api")}><img id="test_page_image" src="https://www.eaglecmms.com/wp-content/uploads/2019/10/REST-API.png" style={{width: '100%', height: '100%'}}/></figure>
